...
import { z } from "zod";
// import { type AuthUse, useRenewal } from "../../pages/Auth/AuthContext";
...
// export const back_post_auth = async (
//   endpoint: string,
//   json: object,
//   auth: AuthUse,
//   options?: Options,
...
// export const back_request = async (
//   endpoint: string,
//   auth: AuthUse,
//   options?: Options,
// ) => {
...
//   const response = await back_request("res/profile/", auth, options);
...
//   const response = await back_request("onboard/get/", auth, options);
...
// export const ud_request = async (
//   auth: AuthUse,
//   options?: Options,
// ): Promise<UsersData> => {
//   const response = await back_request("admin/users/", auth, options);
...
//   const response = await back_request("members/birthdays/", auth, options);
...
// export const u_ud_scopes_request = async (
//   auth: AuthUse,
//   options?: Options,
// ): Promise<Roles> => {
//   const response = await back_request("admin/scopes/all/", auth, options);
...
//   const user_id = auth.authState.username;
//   const req = {
//     user_id,
//   };
//   const response = await back_post_auth(
//     "update/delete/url/",
//     req,
//     auth,
//     options,
