        ...
        <div id="contact_bar">
            <div className="bar_container">
                ...
                <div className="bar_info">
                    <p>Email: <a href="mailto:studentenatletiek@av40.nl" className="bar_link">studentenatletiek@av40.nl</a></p>
                    ...
                    <a href="/files/privacyverklaring_dodeka_jan23.pdf" target="_blank" rel="noreferrer" className="privacy_link">Privacyverklaring Dodeka</a>
                </div>
            </div>
            <div className="bar_container">
                ...
                <div className="bar_info">
                    ...
                    <br/>
                    <p>Dodeka is een trainingsgroep voor studenten binnen <a target="_blank" rel="noreferrer" href="https://www.av40.nl" className="bar_link">AV'40</a></p>
                </div>
            </div>
            <div className="bar_container">
