...
function Gallery(props) {
    ...
    return(
        <div class="flex mt-8 mx-16 pt-2 pb-8 bg-white">
            <h1 class="inline w-32 text-center self-center" onClick={() => setActiveIndex(activeIndex === 0 ? 1 : activeIndex - 1)}>left</h1>
            ...
            <h1 class="inline w-32 text-center self-center" onClick={() => setActiveIndex(activeIndex === 1 ? 0 : activeIndex + 1)}>right</h1>
        </div>   
    )
}
