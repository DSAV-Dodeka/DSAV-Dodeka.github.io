    ...
    <div id="navBar">
      <nav id="navPc">
        ...
        <div id="navItems">
          ...
          <Dropdown name="Vereniging" path="/vereniging" items={[{ name: "Bestuur", path: "/bestuur" }, { name: "Commissies", path: "/commissies" }, { name: "Gezelligheid", path: "/gezelligheid" }, { name: "Arnold", path: "/arnold" }, { name: "OLD", path: "/old"}]} />
          ...
          {authState.isLoaded && authState.isAuthenticated && <Dropdown name="Leden" path="/leden" items={[{ name: "Verjaardagen", path: "/verjaardagen" }, { name: "Klassementen", path: "/klassementen" }, { name: "Hordes", path: "/hordes" }]} />}
        </div>
        <Login />
      </nav>
      <nav id="navMobile">
        ...
        <div id="navMobileContainer" className={active ? "" : " inactive"}>
          <div className={active ? "" : "inactive"}>
            ...
            <MobileDropdown name="Vereniging" path="/vereniging" items={[{name: "Informatie", path: ""}, { name: "Bestuur", path: "/bestuur" }, { name: "Commissies", path: "/commissies" }, { name: "Gezelligheid", path: "/gezelligheid" }, { name: "Arnold", path: "/arnold" }, { name: "OLD", path: "/old"}]} onClick={() => setActive(false)} />
            ...
            {authState.isLoaded && authState.isAuthenticated && <MobileDropdown name="Leden" path="/leden" items={[{ name: "Verjaardagen", path: "/verjaardagen" }, { name: "Klassementen", path: "/klassementen" }, { name: "Hordes", path: "/hordes" }]} onClick={() => setActive(false)}/>}
          </div>
        </div>
      </nav>
    </div>
