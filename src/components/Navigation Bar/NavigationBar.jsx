    ...
    <div id="navBar">
      <nav id="navPc">
        ...
        <div id="navItems">
          ...
          {authState.isLoaded && authState.isAuthenticated && <Dropdown name="Leden" path="/leden" items={[{ name: "Verjaardagen", path: "/verjaardagen" }]} />}
        </div>
        <Login />
      </nav>
      <nav id="navMobile">
        ...
        <div id="navMobileContainer" className={active ? "" : " inactive"}>
          <div className={active ? "" : "inactive"}>
            ...
            {authState.isLoaded && authState.isAuthenticated && <MobileDropdown name="Leden" path="/leden" items={[{ name: "Verjaardagen", path: "/verjaardagen" }]} onClick={() => setActive(false)}/>}
          </div>
        </div>
      </nav>
    </div>
