...
async function clientRegister(username, password) {
    ...
    try {
        ...
        const res = await fetch(`http://localhost:4242/auth/register/start`, {
            method: 'POST', body: JSON.stringify(reqst),
            headers: {
                'Content-Type': 'application/json'
            }
        ...
        // step 2
        // password 'abc'
        //const register_state = "HOqqdRYhiUDCYdEFt224RopWkUyh_bpAOulzXDk7CQeh0_UaT_9jsWAnAxxoxha2ZnFHQAiqLwFHKogQXblAD2FiYw=="
        //const server_message = "3OoePgOwxP0k4Tqn5Cic_6EtcbKb2aAzd7EfZF0ua0j8cilJ2k3wlBxI5tG-aPV_-VNMoit3BFUK-8zO6cYpdA=="
        //const server_message = "Unb4-uxMjhYyrkQXpi4q0awnMMZ4k3JyTdfo9LvHfjrGVBmt60hTg5I8TzpcuB6VAZffJkgztbfI5pETN-l-WA=="
        ...
        const res2 = await fetch(`http://localhost:4242/auth/register/finish`, {
...
async function clientLogin(username, password) {
    ...
    try {
        ...
        const res = await fetch(`http://localhost:4242/auth/login/start`, {
            method: 'POST', body: JSON.stringify(reqst),
            headers: {
                'Content-Type': 'application/json'
            }
        ...
        const res2 = await fetch(`http://localhost:4242/auth/login/finish`, {
            method: 'POST', body: JSON.stringify(reqst2),
            headers: {
                'Content-Type': 'application/json'
            }
...
const Auth = () => {
    ...
    const handleSubmit = async (evt) => {
        ...
        if (isRegister) {
            await clientRegister(username, password)
        }
        else {
