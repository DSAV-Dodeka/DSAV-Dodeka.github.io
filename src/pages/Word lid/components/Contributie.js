...
function Contributie(props) {
    return(
        <div class="contributie_1">
            <img src={require(`../../../images/word_lid/${props.foto}`).default} alt="" class="contributie_2" />
            <div class="contributie_3">
                <Header text="Contributie" position="right"/>
                <p class="contributie_4">
                ...
                <br/><br/>Weet je het nu helemaal zeker? Je vindt <a class="contributie_5" target="_blank" rel="noreferrer" href="https://www.av40.nl/index.php?page=Inschrijfformulier&sid=1"><b>hier</b></a> het inschrijfformulier.
                </p>
            </div>
        </div>
    )
