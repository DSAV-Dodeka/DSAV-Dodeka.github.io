        ...
        <div class="lg:flex bg-blauw bg-opacity-90 w-full mb-8 lg:mb-24">
            <div class="lg:inline py-4 lg:py-0 lg:my-8 w-full lg:w-full">
                ...
                <p class="text-white text-md mx-4 lg:mx-16 mt-4 lg:mt-8">
                    ...
                    Weet je het nu helemaal zeker? Je vindt <a href="https://www.google.com/search?q=how+to+underline+text+in+javascript&rlz=1C1CHBD_enNL916NL916&oq=how+to+underline+text+in+javasc&aqs=chrome.0.0j69i57j0i22i30.4716j0j15&sourceid=chrome&ie=UTF-8">hier</a> het inschrijfformulier.<br></br>
                </p>
            </div>
        </div>
    )
