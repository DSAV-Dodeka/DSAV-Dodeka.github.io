    ...
    return(
        <div className="contributie_1">
            ...
            <div className="contributie_3">
                ...
                <br/><br/>
                Vergeet bij het inschrijven niet aan te vinken dat je student bent, want studentenleden krijgen jaarlijks 10 euro korting op de contributie! Als je dit niet aanvinkt worden de prijzen duurder dan in de prijzentabel hiernaast.
                </p>
            </div>
        </div>
    )
