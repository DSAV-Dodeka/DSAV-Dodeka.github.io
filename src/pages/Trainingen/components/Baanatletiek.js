        ...
        <div class="lg:flex bg-blauw bg-opacity-90 w-full">
            <div class="lg:inline py-4 lg:py-0 lg:my-8 w-full lg:w-1/2">
                ...
                <p class="text-white text-lg mx-4 lg:mx-16 mt-4 lg:mt-8">
                    De baanatletiek trainingen worden gegeven door Koen Stapel, Jasper Rou, Sanne van Beek en Niels Verheugd. 
                    Tijdens deze trainingen komen alle aspecten van baanatletiek aan bod. We trainen op snelheid, kracht, stabiliteit, uithoudingsvermogen en techniek.<br/><br/>
