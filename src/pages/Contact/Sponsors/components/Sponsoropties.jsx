    ...
    return(
        <div className="sponsoropties_1">
            ...
            <Header text="Sponsor ons!" position="left"/>
                ...
                Dodeka staat altijd open voor nieuwe sponsorsamenwerkingen zodat we atletiek voor nog meer Delftse studenten mogelijk en leuker kunnen maken. We bieden veel mogelijkheden om uw organisatie met meer studenten binnen en buiten Delft in contact te brengen. De opties variëren van advertenties in het jaarboek of op instagram tot logo’s op het shirt of website. Indien u geïnteresseerd bent in sponsoren kunt u voor meer informatie mailen naar  <a target="_blank" rel="noreferrer" className="linktomail_1" href="mailto:studentenatletiek@av40.nl">studentenatletiek@av40.nl</a>.
               </p>
