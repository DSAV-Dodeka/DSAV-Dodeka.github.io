        ...
        <div className="record">
            ...
            <div className="activeRecord">
                ...
                <div className="onderdeelPrestaties">
                    ...
                    <svg className="arrowUp" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 16.67l2.829 2.83 9.175-9.339 9.167 9.339 2.829-2.83-11.996-12.17z"/></svg>
                </div>
            </div>
            :
            <div className={"inactiveRecord" + (props.prestaties.length > 1 ? " recordCursor": "")} onClick={props.onClick}>
                <p>{props.onderdeel.toUpperCase()}</p>
                <p>{props.prestaties.length > 0 ? props.prestaties[0].naam  : "Vacant"}</p>
