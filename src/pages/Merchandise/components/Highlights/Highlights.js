    ...
    return(
        <div class="lg:flex pt-8 pb-8 mb-16 lg:mb-24 bg-blauw bg-opacity-90">
            <p class="w-full lg:w-1/2 text-white px-4 pb-4 lg:px-0 lg:pb-0 lg:mx-16">
                Wil je als (nieuw) lid meteen de laatste D.S.A.V. Dodeka fashiontrends volgen? Bestel dan (https://forms.gle/f3RyZiA7Do4oUY696) je D.S.A.V. Dodeka merch! Op dit moment zijn de volgende kledingstukken te bestellen: T-shirt, Jack, Singlet, Hoodie, Joggingbroek. Zie hieronder de foto's voor voorbeelden.
