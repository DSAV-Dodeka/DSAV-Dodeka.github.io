            ...
            {authState.isAuthenticated && (
                <div className="profiel">
                    ...
                    <div className={edit ? "profiel_hidden" : ""}>
                        ...
                        <p className="profiel_info">Telefoonnummer: {profile.phone}</p>
                        <p className="profiel_info">Student: {(profile.eduinstitution === "" ? "Nee" : "Ja")}</p>
                        <p className="profiel_info">Onderwijsinstelling: {profile.eduinstitution}</p>
