        ...
        <div className="OWeeSchema">
            ...
            <div className={showPopup ? "planning hidden" : "planning"}>
                <div className="OWeeDag">
                    <h1 className="OWeeDatum">16 aug</h1>
                    <h1 className="OWeeDatumDag">Zo</h1>
                    <div className="OWeeActiviteit" onClick={popUp}>
                        <h1 className="OWeeActiviteitNaam">Parade</h1>
                        <p className="OWeeActiviteitTijd">14:30-20:00</p>
                        <p className="OWeeActiviteitOmschrijving">Langs de Schie</p>
                    </div>
                ...
                <div className="OWeeDag">
                    <h1 className="OWeeDatum">17 aug</h1>
                    <h1 className="OWeeDatumDag">Ma</h1>
                    <div className="OWeeActiviteit">
                ...
                <div className="OWeeDag">
                    <h1 className="OWeeDatum">19 aug</h1>
                    <h1 className="OWeeDatumDag">Di</h1>
                    <div className="OWeeActiviteit">
                ...
                <div className="OWeeDag">
                    <h1 className="OWeeDatum">20 aug</h1>
                    <h1 className="OWeeDatumDag">Wo</h1>
                    <div className="OWeeActiviteit">
                ...
                <div className="OWeeDag">
                    <h1 className="OWeeDatum">21 aug</h1>
                    <h1 className="OWeeDatumDag">Do</h1>
                    <div className="OWeeActiviteit">
            ...
            <div className={showPopup ? "popup" : "popup hidden"}>
                <h1>Hallo</h1>
                <div className="closePopup" onClick={popUp}></div>
            </div>
        </div>
    )
}
