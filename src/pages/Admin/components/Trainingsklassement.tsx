...
import {Klassement, UserNames} from "../../../functions/api/klassementen";
...
const columnHelper = createColumnHelper<TableTraining>()
...
const Trainingsklassement = () => {
    ...
    const training = queryError(q, defaultTraining, "Class Training Query Error").map((t) => {
        return {
    ...
    const table = useReactTable<TableTraining>({
        data: training,
        columns,
        state: {
            sorting,
