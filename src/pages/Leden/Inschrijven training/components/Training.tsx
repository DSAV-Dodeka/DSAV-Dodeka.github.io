                            ...
                            {props.events.map((item) =>
                                <div className= {onderdeelActive === item ? "training_onderdeel training_onderdeel_active" : "training_onderdeel training_onderdeel_closed"}>
                                    <div className="training_onderdeel_basicinfo">
                                        ...
                                        <div className="training_onderdeel_naam" onClick={() => setOnderdeelActive(item)}>
                                            <p>{item}</p>
                                        </div>
                                        <button className= {onderdeelIngeschreven === item ? "training_onderdeel_inschrijfbutton shadow-on-hover training_onderdeel_inschrijfbutton_ingeschreven" : "training_onderdeel_inschrijfbutton shadow-on-hover"} onClick={() => onderdeelInschrijven(item)}>
