            ...
            {ac.isAuthenticated && (
                ...
                <div className="leden_routes">
                    <Link className="leden_link_double" to="" >
                        ...
                        <img src={getNestedImagesUrl("leden/soon.webp")} className="leden_link_double_image" alt=""/>
                    </Link>
                    <Link className="leden_link" to='klassementen' >
                        <h1 className="leden_link_header">Klassementen</h1>
                        <img src={getNestedImagesUrl("leden/klassementen.webp")} className="leden_link_image" alt=""/>
                    </Link>
                    <Link className="leden_link" to='verjaardagen' >
                        <h1 className="leden_link_header">Verjaardagen</h1>
                        <img src={getNestedImagesUrl("leden/verjaardagen.webp")} className="leden_link_image" alt=""/>
                    </Link>
                </div>
                <div className="leden_routes">
                    <Link className="leden_link" to='' >
                        <h1 className="leden_link_header">Agenda</h1>
                        <img src={getNestedImagesUrl("leden/soon.webp")} className="leden_link_image" alt=""/>
                    </Link>
                    <Link className="leden_link" to='' >
