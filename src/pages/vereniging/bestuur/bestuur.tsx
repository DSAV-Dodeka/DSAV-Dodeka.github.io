...
type BestuursLid = [string, string];
        ...
        <div>
            ...
            <div id="bestuurContainer" className="relative space-y-16 lg:space-y-24 pb-16 lg:pb-24">
                {BestuurText.besturen.map(bestuur =>
                    <Bestuursjaar key={"bestuur" + bestuur.jaar} naam={bestuur.naam} jaar={bestuur.jaar} leden={bestuur.leden as BestuursLid[]} foto={bestuur.foto} />
                )}
