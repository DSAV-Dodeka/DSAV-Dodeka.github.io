  ...
  return (
    <div className="sponsoropties_1">
      <div className="sponsoropties_2">
        ...
        <p className="sponsoropties_3">
          Bij Dodeka bieden wij een hardloopclinic aan, waarbij uw team alle
          tips krijgt om bij de volgende bedrijvenloop nu eens vóór de
          concurrent te eindigen. De training wordt gegeven door een ervaren
          atletiektrainer. Uw team krijgt tips over looptechniek en
          trainingsopbouw. Na de clinic krijgt u wekelijks een schema opgestuurd
          om naar uw afstand toe te werken en een mooie tijd neer te zetten.
          Daarnaast krijgt u toegang tot de Whatsapp hotline, waar een trainer
          eventuele vragen in aanloop naar de wedstrijd zal beantwoorden.
          <br></br>
          <br></br>
          Past deze vorm niet helemaal bij u, maar heeft u wel een ander leuk
          idee? Stel het vooral voor! Wij zijn erg flexibel en denken graag met
          u mee om een mooi resultaat te behalen.
        </p>
        <Header text="Werkacties" position="left" />
        <p className="sponsoropties_3">
          De leden van Dodeka voeren regelmatig werkacties uit bij evenementen,
          om extra inkomsten te verwerven voor de vereniging. Een werkactie is
          voor de leden een leuke en gezellige ervaring en een laagdrempelige
          manier om een steentje bij te dragen aan de vereniging. Onze leden
          zijn enthousiast, flexibel en gewend om samen te werken in een team.
          Organiseert u een evenement en bent u op zoek naar hulpkrachten? Neem
          gerust contact met ons op, dan bespreken we de mogelijkheden.
        </p>
