...
function OWeeText() {
    return(
        <div className="OWeeText">
            ...
            <p className="OWeeParagraph">Jezelf uitdagen, fit blijven en veel gezelligheid en gekkigheid beleven met nieuwe vrienden? Dodeka is dé Delfste Studenten Atletiek Vereniging waar dit allemaal kan! Op zaterdagochtend, maandag- en woensdagavond zijn er trainingen van ervaren trainers. Deze trainingen zijn geschikt voor zowel beginnende als gevorderde atleten en voor ieder is er wat wils! Bij elke training is er een gezamenlijke warming-up bestaande uit inlopen, oefeningen en leuke sportieve spellen. Vervolgens kun je kiezen uit verschillende onderdelen, van technisch, zoals verspringen en kogelstoten, tot sprinten en hardlopen.
                <br/><br/>
