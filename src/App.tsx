...
// );
// const Klassementen = React.lazy(
//   () => import("./pages/Leden/Klassementen/Klassementen"),
// );
...
function App() {
  ...
  //     if (!signal.aborted) {
  //       Logger.debug(
  //         `Setting loaded signal ${signal.aborted} AuthState ${which}...`,
  //       );
  ...
  //       Logger.debug(
  //         `localStorage refresh token changed in another document! new ${compareNew} old ${authState.refresh}`,
  //       );
  ...
  //         setAuthState(as);
  //       } else {
  //         renewAuth(compareNew)
  //           .then((as) => {
  //             Logger.debug(
  //               `Logging in with new details after localStorage update!`,
  //             );
  //             as.isLoaded = true;
  //             setAuthState(as);
  //           })
  ...
  //             Logger.warn({
  //               "renewAuth after localStorage update error": err.j(),
  //             });
  //           });
  //       }
  //     }
  ...
  //   Logger.debug(
  //     `App update after load ${which} or AuthState Change. Loaded: ${authState.isLoaded}. Authenticated: ${authState.isAuthenticated ? authState.it.sub : "false"}`,
  //   );
            ...
            <Routes>
              ...
              {WedstrijdText.wedstrijden.map((item) =>
                item.path === "" ? (
                  ...
                  <Route
                    path={"/wedstrijden" + item.path}
                    key={"wdstr" + item.naam + item.datum}
